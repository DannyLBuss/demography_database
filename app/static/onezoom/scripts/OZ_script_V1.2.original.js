...
function init2()
{
	if (typeof previous_filename == 'undefined' || previous_filename != file_name 
	    ...
	    if (draft_only)
	    {
	        ...
	        tempscript.src = "static/onezoom/user/"+file_name+"_min.js";
	    ...
	    else
	    {
	        ...
	        tempscript.src = "static/onezoom/user/"+file_name+"_tree.js";
	        tempscript.onload = function () {
	            var tempscript2 = document.createElement('script');
	            tempscript2.setAttribute("id", "_meta");
	            tempscript2.src = "static/onezoom/user/"+file_name+"_meta.js";
